# Generated by Django 3.2.6 on 2022-06-07 09:23
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fromUser', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='fromuser', to='myapp.sysuser', verbose_name='از:')),
                ('toUser', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='touser', to='myapp.sysuser', verbose_name='به:')),
            ],
            options={
                'db_table': 'message',
            },
