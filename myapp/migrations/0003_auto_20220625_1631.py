# Generated by Django 3.2.6 on 2022-06-25 12:01
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('PurchaseRequestDateTo', models.DateField(blank=True, null=True, verbose_name='مهلت تا تاریخ')),
                ('PurchaseRequestDateFrom', models.DateField(verbose_name='تاریخ درخواست')),
                ...
                ('PurchaseRequestRequestedUser', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='PurchaseRequestdUser', to='myapp.sysuser', verbose_name='کاربر درخواست کننده')),
            ],
            options={
