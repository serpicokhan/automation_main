var Jobie = function () {
	...
	var moein_chat_check=function(element){
		
		function scrollToBottom() {
				
                let objDiv = document.getElementById("DZ_W_Contacts_Body3");
                objDiv.scrollTop = objDiv.scrollHeight;
            }
        
		const roomName = "room";
		const userName = element.attr("data-url");
		...
		chatSocket.onclose = function(e) {
		  ...
		  if (data.message) {
			  ...
			  var my_id =$("#current_user_id").val();
			  console.log(my_id,data);
			  if(my_id==data.username)
			  {
				  document.querySelector('#DZ_W_Contacts_Body3').innerHTML += ('<div class="d-flex justify-content-start mb-4">                            <div class="img_cont_msg">                                <img src="/static/images/avatar/1.jpg" class="rounded-circle user_img_msg" alt="">                            </div>                            <div class="msg_cotainer">                              '+data.message+'                  <span class="msg_time">9:12 ิศ</span>                            </div>                        </div>');			  }
			  else{
				  document.querySelector('#DZ_W_Contacts_Body3').innerHTML += ('<div class="d-flex justify-content-end mb-4">                            <div class="msg_cotainer_send">                                '+data.message+' <span class="msg_time_send">9:05 ิศ</span>                            </div>                            <div class="img_cont_msg">                                <img src="/static/images/avatar/2.jpg" class="rounded-circle user_img_msg" alt="">                            </div>                        </div>');			 
				  }		
    ...
    return {
        init: function () {
            var l;
            n(), t(), jQuery("#menu").length > 0 && $("#menu").metisMenu(), jQuery(".metismenu > .mm-active ").each(function () {
            ...
            }), l = window.outerHeight, ((l = window.outerHeight) > 0 ? l : screen.height) && $(".content-body").css("min-height", l + 60 + "px"), $('a[data-action="collapse"]').on("click", function (e) {
            ...
            }), jQuery(".deznav-scroll").length > 0 && (new PerfectScrollbar(".deznav-scroll").isRtl = !1), jQuery(".dz-demo-content").length > 0 && (new PerfectScrollbar(".dz-demo-content"), $(".dz-demo-trigger").on("click", function () {
            ...
            e > 1024 && $(".metismenu  li").unbind().each(function (e) {
                if ($("ul", this).length > 0) {
                    var t = (o = $("ul:first", this).css("display", "block")).offset().left, n = o.width(),
                        o = $("ul:first", this).removeAttr("style"), l = ($("body").height(), $("body").width());
                    if (jQuery("html").hasClass("rtl")) var c = t + n <= l; else c = t > 0;
...
jQuery(document).ready(function () {
    ...
    "use strict";
    Jobie.load(), setTimeout(function () {
        Jobie.handleMenuPosition()
    }, 1e3)
}), jQuery(window).on("resize", function () {
    "use strict";
    Jobie.resize(), setTimeout(function () {
        Jobie.handleMenuPosition()
    }, 1e3)
});