...
from myapp.models.parts import PartCategory
#from django.core import serializers
import json
from django.forms.models import model_to_dict
from myapp.forms import PartCategoryForm
from django.urls import reverse_lazy
from django.db import transaction
from django.db import IntegrityError

from rest_framework.decorators import api_view
# from myapp.api.WOSerializer import PartCategorySerializer
from rest_framework.response import Response

def list_partCategory(request,id=None):
    #
    books = PartCategory.objects.all()
    return render(request, 'myapp/partcategory/partCategoryList.html', {'partCategory': books,'section':'list_partCategory'})
...
def save_partCategory_form(request, form, template_name,id=None):
    ...
    if (request.method == 'POST'):
        ...
        if form.is_valid():
                ...
                books = PartCategory.objects.all()
                data['html_partCategory_list'] = render_to_string('myapp/partcategory/partialPartCategoryList.html', {
                    'partCategory': books
                })
...
def partCategory_delete(request, id):
    ...
    if (request.method == 'POST'):
        ...
        data['html_partCategory_form'] = render_to_string('myapp/partcategory/partialPartCategoryDelete.html',
            context,
            request=request,
        )
    return JsonResponse(data)
...
def partCategory_create(request):
    if (request.method == 'POST'):
        ...
        return save_partCategory_form(request, form, 'myapp/partcategory/partialPartCategoryCreate.html')
    else:
...
def partCategory_update(request, id):
    ...
    return save_partCategory_form(request, form,"myapp/partcategory/partialPartCategoryUpdate.html",id)
##########################################################
